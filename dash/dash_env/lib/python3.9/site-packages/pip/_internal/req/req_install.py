...
class InstallRequirement:
    ...
    def format_debug(self) -> str:
        ...
        state = ("{}={!r}".format(attr, attributes[attr]) for attr in
                 sorted(names))
    ...
    def load_pyproject_toml(self) -> None:
        ...
        follow the PEP 517 or legacy (setup.py) sample_code path.
        """
        pyproject_toml_data = load_pyproject_toml(
                self.use_pep517, self.pyproject_toml_path, self.setup_py_path,
                str(self)
        )
