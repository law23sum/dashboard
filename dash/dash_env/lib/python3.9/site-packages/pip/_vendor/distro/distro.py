...
def linux_distribution(full_distribution_name: bool = True) -> Tuple[
    str, str, str]:
    """
    .. deprecated:: 1.6.0
    ...
    def _parse_os_release_content(lines: TextIO) -> Dict[str, str]:
        ...
        * lines: Iterable through the lines in the os-release file.
        ...
        if "version_codename" in props:
            ...
            # do not have sample_code names.  They should be setting
            # version_codename=""
...
def main() -> None:
    ...
    parser.add_argument(
            "--json", "-j", help="Output in machine readable format",
            action="store_true"
    )
