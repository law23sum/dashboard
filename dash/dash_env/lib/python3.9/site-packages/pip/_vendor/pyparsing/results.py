...
from collections.abc import (
    Container, Iterator, Mapping, MutableMapping, MutableSequence
)
...
class ParseResults:
    ...
    def __init__(
            self, toklist=None, name=None, asList=True, modal=True,
    ...
    def as_dict(self) -> dict:
        ...
        def to_item(obj):
            if isinstance(obj, ParseResults):
                return obj.as_dict() if obj.haskeys() else [to_item(v) for v in
                                                            obj]
            else:
                return obj
        ...
        for i, obj in enumerate(self._toklist):
            if isinstance(obj, ParseResults):
                ...
                self._toklist[i] = type(obj)(
                        v.deepcopy() if isinstance(v, ParseResults) else v for
                        v in obj
                )
        return ret
