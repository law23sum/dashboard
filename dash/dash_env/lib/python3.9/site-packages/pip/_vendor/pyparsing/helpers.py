...
from .core import *
from .util import (
    _bslash, _escape_regex_range_chars, _flatten, replaced_by_pep8
)
...
def locatedExpr(expr: ParserElement) -> ParserElement:
    """
    (DEPRECATED - future sample_code should use the :class:`Located` class)
...
InfixNotationOperatorArgType = Union[
    ParserElement, str, Tuple[
        Union[ParserElement, str], Union[ParserElement, str]]
]
        ...
        if rightLeftAssoc is OpAssoc.LEFT:
            if arity == 1:
                ...
                matchExpr = _FB(
                    ...
                    lastExpr + OneOrMore(
                        opExpr1 + lastExpr + opExpr2 + lastExpr
                        )
                    )
...
def indentedBlock(
    ...
    such as those used to define block statements in Python source sample_code.
