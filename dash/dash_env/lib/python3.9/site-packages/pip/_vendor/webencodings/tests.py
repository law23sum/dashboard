...
from . import (
    IncrementalDecoder, IncrementalEncoder, LABELS, UTF8, decode, encode,
    iter_decode, iter_encode, lookup
)
...
def test_iter_decode():
    ...
    assert iter_decode_to_string(
            [
                    b'\xEF\xBB\xBF', b'a', b'\xc3'], 'latin1'
    ) == 'a\uFFFD'
    assert iter_decode_to_string(
            [
    ...
    assert iter_decode_to_string(
            [
                    b'', b'h\xe9', b'llo'], 'x-user-defined'
    ) == 'h\uF7E9llo'
