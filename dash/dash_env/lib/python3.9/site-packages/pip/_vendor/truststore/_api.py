...
_StrOrBytesPath: typing.TypeAlias = str | bytes | os.PathLike[str] | \
                                    os.PathLike[bytes]
...
class SSLContext(_truststore_SSLContext_super_class):  # type: ignore[misc]
    ...
    def load_verify_locations(
            self,
            cafile: str | bytes | os.PathLike[str] | os.PathLike[
                bytes] | None = None,
            capath: str | bytes | os.PathLike[str] | os.PathLike[
                bytes] | None = None,
    ...
    @typing.overload
    def get_ca_certs(self, binary_form: typing.Literal[True] = ...) -> list[
        bytes]:
        ...
    ...
    def get_ca_certs(self, binary_form: bool = False) -> list[typing.Any] | \
                                                         list[bytes]:
        raise NotImplementedError()
...
def _verify_peercerts(
    ...
    cert_bytes = [cert.public_bytes(_ssl.ENCODING_DER) for cert in
                  unverified_chain]
