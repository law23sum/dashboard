...
import ssl
import typing
from ctypes import POINTER, Structure, WinDLL, WinError, c_char_p, c_ulong, \
    c_void_p, c_wchar_p, cast, create_unicode_buffer, pointer, \
    sizeof  # type: ignore; type: ignore
...
def _verify_peercerts_impl(
    ...
    try:
        ...
        pCertContext = CertCreateCertificateContext(
                X509_ASN_ENCODING | PKCS_7_ASN_ENCODING, leaf_cert,
                len(leaf_cert)
        )
...
def _get_and_verify_cert_chain(
    ...
    try:
        ...
        if error_code:
            # Try getting a human readable message for an error sample_code.
            ...
            # error sample_code and hope that it's search-able.
