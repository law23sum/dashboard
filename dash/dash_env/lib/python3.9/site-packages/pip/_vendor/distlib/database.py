...
from .metadata import (
    LEGACY_METADATA_FILENAME, METADATA_FILENAME, Metadata,
...
class Distribution(object):
    ...
    def _get_requirements(self, req_attr):
        ...
        logger.debug(
            '%s: got requirements %r from metadata: %r', self.name, req_attr,
            reqts
            )
        return set(
            md.get_requirements(
                reqts, extras=self.extras,
                env=self.context
                )
            )
        ...
        def parse_requires_data(data):
            ...
            *data*: the contents of a setuptools-produced requires.txt file.
            ...
            for line in lines:
                ...
                if line.startswith('['):
                    logger.warning(
                        'Unexpected line: quitting requirement scan: %r',
                        line
                        )
                    break
