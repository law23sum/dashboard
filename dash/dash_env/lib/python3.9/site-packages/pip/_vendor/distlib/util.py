...
from .compat import (
    string_types, text_type, shutil, raw_input, StringIO,
...
#
# Requirement parsing sample_code as per PEP 508
#
...
def parse_requirement(req):
    ...
    if not versions:
        ...
        rs = '%s %s' % (
        distname, ', '.join(['%s %s' % con for con in versions]))
    return Container(
        name=distname, extras=extras, constraints=versions,
...
if ssl:
    from .compat import (
        HTTPSHandler as BaseHTTPSHandler, match_hostname,
        CertificateError
    )
