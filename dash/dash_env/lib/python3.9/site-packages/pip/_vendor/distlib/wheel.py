...
from .metadata import (
    LEGACY_METADATA_FILENAME, Metadata, WHEEL_METADATA_FILENAME
)
from .util import (
    CSVReader, CSVWriter, Cache, FileOperator, cached_property, convert_path,
...
class Wheel(object):
    ...
    def _get_dylib_cache(self):
        ...
        if cache is None:
            ...
            base = os.path.join(
                get_cache_base(), str('dylib-cache'),
    ...
    def update(self, modifier, dest_dir=None, **kwargs):
        ...
        def update_version(version, path):
            ...
            if updated:
                ...
                logger.debug(
                    'Version updated from %r to %r', version,
                    updated
                    )
