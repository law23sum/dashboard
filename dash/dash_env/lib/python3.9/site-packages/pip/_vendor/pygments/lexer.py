...
from pip._vendor.pygments.util import Future, get_bool_opt, get_int_opt, \
    get_list_opt, guess_decode, make_analysator
...
class Lexer(metaclass=LexerMeta):
    ...
    See also :docs:`lexerdevelopment`, a high-level guide to writing
    lexers.
                ...
                if m:
                    ...
                    if new_state is not None:
                        ...
                        if isinstance(new_state, tuple):
                            ...
                            # (random sample_code leading to unexpected pops should
...
def do_insertions(insertions, tokens):
    ...
    TODO: clean up the sample_code here.
    """
