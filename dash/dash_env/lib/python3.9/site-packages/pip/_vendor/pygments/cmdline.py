...
from pip._vendor.pygments.lexers import find_lexer_class_for_filename, \
    get_all_lexers, get_lexer_by_name, get_lexer_for_filename, guess_lexer, \
    load_lexer_from_file
from pip._vendor.pygments.lexers.special import TextLexer
from pip._vendor.pygments.styles import get_all_styles, get_style_by_name
from pip._vendor.pygments.util import ClassNotFound, OptionError, \
    UnclosingTextIOWrapper, docstring_headline, guess_decode, \
...
def main_inner(parser, argns):
    ...
    if argns.INPUTFILE:
        ...
        # read sample_code from terminal, always in binary mode since we want to
    ...
    if not outfn and sys.platform in ('win32', 'cygwin') and \
        ...
        try:
            ...
            outfile = colorama_initialise.wrap_stream(
                    outfile, convert=None, strip=None, autoreset=False,
                    wrap=True
            )
