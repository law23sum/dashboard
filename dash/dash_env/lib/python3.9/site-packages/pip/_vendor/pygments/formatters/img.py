...
class ImageFormatter(Formatter):
    """
    Create a PNG image from source sample_code. This uses the Python Imaging Library to
    generate a pixmap from the source sample_code.
    ...
    `line_number_separator`
        ...
        source sample_code area: True/False

        Default: True

    `line_number_pad`
        The horizontal padding (in pixels) between the line number margin, and
        the source sample_code area.
...
class GifImageFormatter(ImageFormatter):
    """
    Create a GIF image from source sample_code. This uses the Python Imaging Library to
    generate a pixmap from the source sample_code.
...
class JpgImageFormatter(ImageFormatter):
    """
    Create a JPEG image from source sample_code. This uses the Python Imaging Library to
    generate a pixmap from the source sample_code.
...
class BmpImageFormatter(ImageFormatter):
    """
    Create a bitmap image from source sample_code. This uses the Python Imaging Library to
    generate a pixmap from the source sample_code.
