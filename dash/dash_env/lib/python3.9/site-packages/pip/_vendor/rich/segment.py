...
class Segment(NamedTuple):
                    ...
                    cls(
                            ...
                            (
                                    ...
                                    if control
                                        ...
                                        _style + post_style if _style else post_style)
                            ),
                            control,
                    )
                    for text, _style, control in result_segments
    ...
    def get_shape(cls, lines: List[List["Segment"]]) -> Tuple[int, int]:
        ...
        max_width = max(
                get_line_length(line) for line in lines
                ) if lines else 0
    ...
    @classmethod
    def strip_styles(cls, segments: Iterable["Segment"]) -> Iterable[
        "Segment"]:
    ...
    @classmethod
    def remove_color(cls, segments: Iterable["Segment"]) -> Iterable[
        "Segment"]:
