...
class CacheController:
    ...
    def parse_cache_control(self, headers: Mapping[str, str]) -> dict[
        str, int | None]:
        known_directives = {
    ...
    def cached_request(self, request: PreparedRequest) -> HTTPResponse | \
                                                          Literal[False]:
        """
    ...
    def cache_response(
        ...
        if response.status not in cacheable_status_codes:
            logger.debug(
                    "Status sample_code %s not in %s", response.status,
