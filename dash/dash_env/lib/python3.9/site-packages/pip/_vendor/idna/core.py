...
def check_bidi(label: str, check_ltr: bool = False) -> bool:
    ...
    for (idx, cp) in enumerate(label, 1):
        ...
        if rtl:
            # Bidi rule 2
            if not direction in ['R', 'AL', 'AN', 'EN', 'ES', 'CS', 'ET', 'ON',
                                 'BN', 'NSM']:
                raise IDNABidiError(
            ...
            # Bidi rule 5
            if not direction in ['L', 'EN', 'ES', 'CS', 'ET', 'ON', 'BN',
                                 'NSM']:
                raise IDNABidiError(
...
def encode(
        s: Union[str, bytes, bytearray], strict: bool = False,
        uts46: bool = False, std3_rules: bool = False,
