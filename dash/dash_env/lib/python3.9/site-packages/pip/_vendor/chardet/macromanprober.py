######################## BEGIN LICENSE BLOCK ########################
# This sample_code was modified from latin1prober.py by Rob Speer <rob@lumino.so>.
...
#   Shy Shalom - original C sample_code
#
...
class MacRomanProber(CharSetProber):
    ...
    def get_confidence(self) -> float:
        ...
        confidence = (
                0.0
                if total < 0.01
                else (self._freq_counter[3] - self._freq_counter[
                    1] * 20.0) / total
        )
