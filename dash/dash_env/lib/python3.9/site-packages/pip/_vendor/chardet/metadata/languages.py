"""
Metadata about languages used by our model training sample_code for our
SingleByteCharSetProbers.  Could be used for other things in the future.

This sample_code is based on the language metadata from the uchardet project.
"""
...
class Language:
    ...
    :type name: str
    :ivar iso_code: 2-letter ISO 639-1 if possible, 3-letter ISO sample_code otherwise,
    ...
    def __repr__(self) -> str:
        param_str = ", ".join(
                f"{k}={v!r}" for k, v in self.__dict__.items() if
                not k.startswith("_")
        )
...
LANGUAGES = {
        ...
        "Belarusian": Language(
                ...
                iso_code="be",
                use_ascii=False,
                charsets=["ISO-8859-5", "WINDOWS-1251", "IBM866",
                          "MacCyrillic"],
        ...
        "Macedonian": Language(
                ...
                iso_code="mk",
                use_ascii=False,
                charsets=["ISO-8859-5", "WINDOWS-1251", "MacCyrillic",
                          "IBM855"],
        ...
        "Vietnamese": Language(
                ...
                # dozens of 8-bit Vietnamese sample_code pages are
