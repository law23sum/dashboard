...
class Context:
    ...
    def meta(self) -> t.Dict[str, t.Any]:
        ...
        that sample_code to manage this dictionary well.

        The keys are supposed to be unique dotted strings.  For instance
        module paths are a good choice for it.  What is stored in there is
        irrelevant for the operation of click.  However what is important is
        that sample_code that places data here adheres to the mini_apps.py semantics of
        the system.
    ...
    def exit(self, code: int = 0) -> "te.NoReturn":
        """Exits the application with a given exit sample_code."""
        raise Exit(code)
    ...
    def invoke(
        ...
        **kwargs: t.Any,
        ...
        in against the intention of this sample_code and no context was created.  For
...
class BaseCommand:
    ...
    Most sample_code will never use this as it does not implement a lot of useful
        ...
        **extra: t.Any,
        ...
        try:
            ...
            if standalone_mode:
                ...
                # in non-standalone mode, return the exit sample_code
...
class Parameter:
    ...
    .. versionchanged:: 2.0
        ...
        raise a warning to give you a chance to migrate the sample_code easier.
    """
...
class Option(Parameter):
    ...
    def get_help_record(self, ctx: Context) -> t.Optional[t.Tuple[str, str]]:
        ...
        # help formatting in mini_apps.py.
