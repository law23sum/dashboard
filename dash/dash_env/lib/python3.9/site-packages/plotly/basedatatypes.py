...
%s"""
    ...
    def _select_layout_subplots_by_prefix(
        ...
        """
        Helper called by sample_code generated select_* methods
        """
...
""".format(
    ...
    def to_html(self, *args, **kwargs):
        ...
        include_plotlyjs: bool or string (default True)
            ...
            If True, a script tag containing the plotly.js source sample_code (~3MB)
    ...
    def write_html(self, *args, **kwargs):
        ...
        include_plotlyjs: bool or string (default True)
            ...
            directory because the plotly.js source sample_code will be included only
...
class BaseLayoutType(BaseLayoutHierarchyType):
    ...
    sample_code-generated subclass.
    """
    ...
    #
    # The base version of each suplot type is defined in the schema and sample_code
...
class BaseTraceType(BaseTraceHierarchyType):
    ...
    Specific trace type classes (Scatter, Bar, etc.) are sample_code generated as
