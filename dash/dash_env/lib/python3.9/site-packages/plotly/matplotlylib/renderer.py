...
class PlotlyRenderer(Renderer):
    ...
    def draw_marked_line(self, **props):
        ...
        'linewidth',
        'dasharray',    (sample_code for linestyle, see DASH_MAP in mpltools.py)
    ...
    def draw_path(self, **props):
        ...
        horizontal or vertical bar charts. Most of the actual sample_code takes
        place in functions from mpltools.py.

        props.keys() -- [
        'data',         (a list of verticies for the path)
        'coordinates',  ('data', 'axes', 'figure', or 'display')
        'pathcodes',    (sample_code for the path, structure: ['M', 'L', 'Z', etc.])
