...
def export_color(color):
    """Convert matplotlib color sample_code to hex color or RGBA color"""
...
def get_dasharray(obj):
    ...
    obj : matplotlib object
        ...
        method which returns a valid matplotlib line sample_code

    Returns
    -------
    dasharray : string
        The HTML/SVG dasharray sample_code associated with the object.
    """
...
def SVG_path(path, transform=None, simplify=False):
    ...
    path_codes : list
        A length N list of single-character path codes, N <= M. Each sample_code is
