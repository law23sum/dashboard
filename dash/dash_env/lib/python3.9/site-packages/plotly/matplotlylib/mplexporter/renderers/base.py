...
class Renderer(object):
    ...
    def draw_line(self, data, coordinates, style, label, mplobj=None):
        ...
        coordinates : string
            A string sample_code, which should be either 'data' for data coordinates,
    ...
    def draw_path_collection(
        ...
        path_coordinates: string
            the coordinates sample_code for the paths, which should be either
        ...
        offset_coordinates : string
            the coordinates sample_code for the offsets, which should be either
            'data' for data coordinates, or 'figure' for figure (pixel)
            coordinates.
        offset_order : string
    ...
    def draw_path(
        ...
        pathcodes : list
            ...
            in mini_apps.py, the length of the pathcodes list will not be the same
