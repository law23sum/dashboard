...
InputDeviceState(
    ...
    def button(self):
        """
        Integer sample_code for the button that was pressed on the mouse to trigger
        the event
    ...
    def buttons(self):
        """
        Integer sample_code for which combination of buttons are pressed on the
        ...
        will result in a sample_code of 5
