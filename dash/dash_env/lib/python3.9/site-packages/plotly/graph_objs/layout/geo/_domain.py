...
class Domain(_BaseLayoutHierarchyType):
    ...
    def column(self):
        ...
        constrained by domain. In mini_apps.py, when `projection.scale` is
    ...
    def x(self):
        """
            ...
            mini_apps.py, when `projection.scale` is set to 1. a map will fit
    ...
    def _prop_descriptions(self):
        ...
        column
            ...
            subplots are constrained by domain. In mini_apps.py, when
        ...
        x
            ...
            domain. In mini_apps.py, when `projection.scale` is set to
