...
def _get_jconfig(config=None):
    ...
    if config and isinstance(config, dict):
        ...
        # rather than an error since we don't have sample_code generation logic in
...
def plot(
    ...
    include_plotlyjs (True | False | 'cdn' | 'directory' | path - default=True)
        ...
        the same directory because the plotly.js source sample_code will be included
...
def plot_mpl(
    ...
    include_plotlyjs (default=True) -- If True, include the plotly.js
        source sample_code in the output file or string.
