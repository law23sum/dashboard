...
class Dash:
    ...
    :param extra_hot_reload_paths: A list of paths to watch for changes, in
        addition to assets and known Python and JS sample_code, if hot reloading is
        enabled.
    ...
    def csp_hashes(self, hash_algorithm="sha256"):
        ...
        one of the biggest benefits of CSP (disallowing mini_apps.py inline scripts)
    ...
    def enable_dev_tools(
        ...
        :param dev_tools_serve_dev_bundles: Serve the dev bundles. Production
            bundles do not necessarily include all the dev tools sample_code.
        ...
        :param dev_tools_prune_errors: Reduce tracebacks to just user sample_code,
