...
class Input(Component):
    ...
    - minLength (string | number; optional):
        ...
        of characters (in Unicode sample_code points) that the user can enter.
    ...
    - maxLength (string | number; optional):
        ...
        of characters (in UTF-16 sample_code units) that the user can enter. For
    ...
    - pattern (string; optional):
        ...
        as a sequence of unicode sample_code points. The pattern is not
