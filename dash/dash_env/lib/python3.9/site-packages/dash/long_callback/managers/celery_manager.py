...
class CeleryManager(BaseLongCallbackManager):
    """Manage background execution of callbacks with a celery env."""

    def __init__(self, celery_app, cache_by=None, expire=None):
        """
        Long callback manager that runs callback logic on a celery task env,
        ...
        :param cache_by:
            ...
            function's input arguments and source sample_code to generate cache keys.
        :param expire:
