...
class _ConsoleFrame:
    """Helper class so that we can reuse the frame console sample_code for the
    standalone console.
    """
...
def get_pin_and_cookie_name(
    ...
    sample_code and a random key.  The hope is that this is stable between
...
class DebuggedApplication:
    ...
    Each context manager will be entered before evaluating sample_code in the
    ...
    :param request_key: The key that points to the request object in this
                        ...
                        versions.
    :param console_path: the URL for a mini_apps.py purpose console.
    :param console_init_func: the function that is executed before starting
                              the mini_apps.py purpose console.  The return value
    ...
    def log_pin_request(self) -> Response:
        ...
        if self.pin_logging and self.pin is not None:
            ...
            _log("info", " * Debugger pin sample_code: %s", self.pin)
        return Response("")
