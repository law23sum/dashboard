...
<div class="plain">
    ...
    <textarea cols="50" rows="10" name="sample_code" readonly>%(plaintext)s</textarea>
</div>
<div class="explanation">
  The debugger caught an exception in your WSGI application.  You can now
  look at the traceback which led to the error.  <span class="nojavascript">
  If you enable JavaScript you can also use additional features such as sample_code
...
<div class="frame" id="frame-%(id)d">
  <h4>File <cite class="filename">"%(filename)s"</cite>,
      ...
      in <sample_code class="function">%(function_name)s</sample_code></h4>
...
def _process_traceback(
    ...
    *,
    ...
    # The codeop module is used to compile sample_code from the interactive
...
class DebugFrameSummary(traceback.FrameSummary):
    """A :class:`traceback.FrameSummary` that can evaluate sample_code in the
    frame's namespace.
    """
