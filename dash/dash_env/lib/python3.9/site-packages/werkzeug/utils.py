...
def redirect(
    ...
    :param code: the redirect status sample_code. defaults to 302.
...
def append_slash_redirect(environ: WSGIEnvironment, code: int = 308) -> Response:
    ...
    .. versionchanged:: 2.1
        The default status sample_code is 308 instead of 301. This preserves
...
def send_file(
    ...
    if conditional:
        ...
        # status sample_code and send the file anyway.
