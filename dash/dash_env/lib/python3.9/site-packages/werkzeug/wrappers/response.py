...
class Response(_SansIOResponse):
    ...
    #:    your sample_code to the name change.
    ...
    def get_wsgi_headers(self, environ: WSGIEnvironment) -> Headers:
        ...
        if 100 <= status < 200 or status == 204:
            ...
            # sample_code of 1xx (Informational) or 204 (No Content)."
    ...
    def get_app_iter(self, environ: WSGIEnvironment) -> t.Iterable[bytes]:
        ...
        on the request method and the current status sample_code the return value
        might be an empty response rather than the one from the response.

        If the request method is `HEAD` or the status sample_code is in a range
    ...
    def get_wsgi_response(
        ...
        be empty and only the headers and status sample_code will be present.
