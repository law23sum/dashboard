...
class Retry:
    ...
    :param int redirect:
        ...
        A redirect is a HTTP response with a status sample_code 301, 302, 303, 307 or
        308.
    ...
    :param int status:
        ...
        These are retries made on responses, where status sample_code matches
        ``status_forcelist``.
    ...
    :param Collection status_forcelist:
        ...
        and the response status sample_code is in ``status_forcelist``.
    ...
    :param bool raise_on_redirect: Whether, if the number of redirects is
        ...
        response sample_code in the 3xx range.
    ...
    def is_retry(
        ...
        """Is this method/status sample_code retryable? (Based on allowlists and control
        variables such as the number of total retries to allow, whether to
        respect the Retry-After header, whether this header is present, and
        whether the returned status sample_code is on the list of status codes to
